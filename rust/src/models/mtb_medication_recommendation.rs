...
impl MtbMedicationRecommendation {
    pub fn new(priority: models::RecommendationPriorityCoding, medication: Vec<models::AtcUnregisteredMedicationCoding>, issued_on: String, patient: models::Reference, id: String) -> MtbMedicationRecommendation {
