...
pub struct MtbSystemicTherapy {
    ...
    #[serde(rename = "recommendationFulfillmentStatus", skip_serializing_if = "Option::is_none")]
    pub recommendation_fulfillment_status: Option<models::MtbSystemicTherapyRecommendationFulfillmentStatusCoding>,
    #[serde(rename = "id")]
    pub id: String,
...
impl MtbSystemicTherapy {
    pub fn new(id: String, recorded_on: String, status: models::TherapyStatusCoding, patient: models::Reference) -> MtbSystemicTherapy {
        MtbSystemicTherapy {
            status_reason: None,
            medication: None,
            intent: None,
