...
impl Snv {
    pub fn new(transcript_id: models::TranscriptId, chromosome: models::Chromosome, id: String, alt_allele: String, position: models::CnvEndRange, gene: models::Coding, dna_change: String, patient: models::Reference, ref_allele: String, read_depth: i32, allelic_frequency: f64) -> Snv {
        Snv {
            localization: None,
            protein_change: None,
            interpretation: None,
