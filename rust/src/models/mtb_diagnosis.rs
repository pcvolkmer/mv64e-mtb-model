...
pub struct MtbDiagnosis {
    ...
    #[serde(rename = "guidelineTreatmentStatus", skip_serializing_if = "Option::is_none")]
...
impl MtbDiagnosis {
    pub fn new(code: models::Coding, id: String, recorded_on: String, r#type: models::MtbDiagnosisType, patient: models::Reference, topography: models::Coding) -> MtbDiagnosis {
        MtbDiagnosis {
            grading: None,
            germline_codes: None,
            code,
