...
impl MtbCarePlanProcedureRecommendationsInner {
    pub fn new(priority: models::RecommendationPriorityCoding, code: models::MtbProcedureRecommendationCategoryCoding, issued_on: String, patient: models::Reference, id: String) -> MtbCarePlanProcedureRecommendationsInner {
