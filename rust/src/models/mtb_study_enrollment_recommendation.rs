...
impl MtbStudyEnrollmentRecommendation {
    pub fn new(priority: models::RecommendationPriorityCoding, patient: models::Reference, id: String, issued_on: String, study: Vec<models::StudyReference>) -> MtbStudyEnrollmentRecommendation {
