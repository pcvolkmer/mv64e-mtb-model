...
pub struct MtbCarePlan {
    ...
    #[serde(rename = "recommendationsMissingReason", skip_serializing_if = "Option::is_none")]
    pub recommendations_missing_reason: Option<models::MtbCarePlanRecommendationsMissingReasonCoding>,
    #[serde(rename = "studyEnrollmentRecommendations", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "geneticCounselingRecommendation", skip_serializing_if = "Option::is_none")]
    pub genetic_counseling_recommendation: Option<models::GeneticCounselingRecommendation>,
    #[serde(rename = "id")]
    pub id: String,
    #[serde(rename = "medicationRecommendations", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "histologyReevaluationRequests", skip_serializing_if = "Option::is_none")]
    pub histology_reevaluation_requests: Option<Vec<models::MtbCarePlanHistologyReevaluationRequestsInner>>,
    #[serde(rename = "notes", skip_serializing_if = "Option::is_none")]
    pub notes: Option<Vec<String>>,
    #[serde(rename = "procedureRecommendations", skip_serializing_if = "Option::is_none")]
    pub procedure_recommendations: Option<Vec<models::MtbCarePlanProcedureRecommendationsInner>>,
    #[serde(rename = "issuedOn")]
    pub issued_on: String,
    #[serde(rename = "noSequencingPerformedReason", skip_serializing_if = "Option::is_none")]
