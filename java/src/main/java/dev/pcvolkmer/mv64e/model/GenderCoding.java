...
public class GenderCoding {
  ...
  public boolean equals(Object o) {
    ...
    GenderCoding genderCoding = (GenderCoding) o;
    return Objects.equals(this.code, genderCoding.code)
        && Objects.equals(this.display, genderCoding.display)
        && Objects.equals(this.system, genderCoding.system)
        && Objects.equals(this.version, genderCoding.version);
  }
  ...
  public static class Builder {
    ...
    private GenderCoding instance;

    public Builder() {
      this(new GenderCoding());
    }

    protected Builder(GenderCoding instance) {
      this.instance = instance;
    }

    public GenderCoding.Builder code(CodeEnum code) {
  ...
  public static GenderCoding.Builder builder() {
    return new GenderCoding.Builder();
  }

  public GenderCoding.Builder toBuilder() {
    return new GenderCoding.Builder()
        .code(getCode())
        .display(getDisplay())
        .system(getSystem())
