...
public class TumorSpecimenCollectionMethodCoding {
  ...
  public String toString() {
    ...
    sb.append("class TumorSpecimenCollectionMethodCoding {\n");
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new TumorSpecimenCollectionMethodCoding());
    }

    protected Builder(TumorSpecimenCollectionMethodCoding instance) {
      this.instance = instance;
    }

    public TumorSpecimenCollectionMethodCoding.Builder code(CodeEnum code) {
      this.instance.code = code;
      return this;
    }

    public TumorSpecimenCollectionMethodCoding.Builder display(@Nullable String display) {
      this.instance.display = display;
      return this;
    }

    public TumorSpecimenCollectionMethodCoding.Builder system(@Nullable String system) {
      this.instance.system = system;
      return this;
    }

    public TumorSpecimenCollectionMethodCoding.Builder version(@Nullable String version) {
  ...
  public static TumorSpecimenCollectionMethodCoding.Builder builder() {
