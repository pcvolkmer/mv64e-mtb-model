...
public class TherapyStatusCoding {
  ...
  public static class Builder {
    ...
    public TherapyStatusCoding.Builder display(@Nullable String display) {
      this.instance.display = display;
      return this;
    }

    public TherapyStatusCoding.Builder system(@Nullable String system) {
      this.instance.system = system;
      return this;
    }

    public TherapyStatusCoding.Builder version(@Nullable String version) {
