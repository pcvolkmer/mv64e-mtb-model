...
public class CnvTypeCoding {
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new CnvTypeCoding());
    }

    protected Builder(CnvTypeCoding instance) {
      this.instance = instance;
    }

    public CnvTypeCoding.Builder code(CodeEnum code) {
  ...
  public static CnvTypeCoding.Builder builder() {
