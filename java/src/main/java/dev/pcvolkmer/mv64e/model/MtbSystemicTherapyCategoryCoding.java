...
public class MtbSystemicTherapyCategoryCoding {
  ...
  public String toString() {
    ...
    sb.append("class MtbSystemicTherapyCategoryCoding {\n");
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new MtbSystemicTherapyCategoryCoding());
    }

    protected Builder(MtbSystemicTherapyCategoryCoding instance) {
      this.instance = instance;
    }

    public MtbSystemicTherapyCategoryCoding.Builder code(CodeEnum code) {
  ...
  public static MtbSystemicTherapyCategoryCoding.Builder builder() {
