...
public class MtbCarePlanProcedureRecommendationsInner {
  ...
  public String toString() {
    ...
    sb.append("class MtbCarePlanProcedureRecommendationsInner {\n");
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new MtbCarePlanProcedureRecommendationsInner());
    }

    protected Builder(MtbCarePlanProcedureRecommendationsInner instance) {
  ...
  public static MtbCarePlanProcedureRecommendationsInner.Builder builder() {
