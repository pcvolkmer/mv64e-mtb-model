...
public class FollowUpPatientStatusCoding {
  ...
  public boolean equals(Object o) {
    ...
    FollowUpPatientStatusCoding followUpPatientStatusCoding = (FollowUpPatientStatusCoding) o;
    return Objects.equals(this.code, followUpPatientStatusCoding.code)
        && Objects.equals(this.display, followUpPatientStatusCoding.display)
        && Objects.equals(this.system, followUpPatientStatusCoding.system)
        && Objects.equals(this.version, followUpPatientStatusCoding.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class FollowUpPatientStatusCoding {\n");
  ...
  public static class Builder {
    ...
    private FollowUpPatientStatusCoding instance;

    public Builder() {
      this(new FollowUpPatientStatusCoding());
    }

    protected Builder(FollowUpPatientStatusCoding instance) {
      this.instance = instance;
    }

    public FollowUpPatientStatusCoding.Builder code(CodeEnum code) {
    ...
    public FollowUpPatientStatusCoding build() {
      try {
  ...
  public static FollowUpPatientStatusCoding.Builder builder() {
    return new FollowUpPatientStatusCoding.Builder();
  }

  public FollowUpPatientStatusCoding.Builder toBuilder() {
    return new FollowUpPatientStatusCoding.Builder()
        .code(getCode())
        .display(getDisplay())
        .system(getSystem())
