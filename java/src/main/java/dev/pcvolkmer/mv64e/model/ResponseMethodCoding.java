...
public class ResponseMethodCoding {
  ...
  public String toString() {
    ...
    sb.append("class ResponseMethodCoding {\n");
  ...
  public static class Builder {
    ...
    public Builder() {
      this(new ResponseMethodCoding());
    }

    protected Builder(ResponseMethodCoding instance) {
      this.instance = instance;
    }

    public ResponseMethodCoding.Builder code(CodeEnum code) {
  ...
  public static ResponseMethodCoding.Builder builder() {
