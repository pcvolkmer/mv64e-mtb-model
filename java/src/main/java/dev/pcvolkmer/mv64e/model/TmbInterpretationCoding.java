...
public class TmbInterpretationCoding {
  ...
  public boolean equals(Object o) {
    ...
    TmbInterpretationCoding tmbInterpretationCoding = (TmbInterpretationCoding) o;
    return Objects.equals(this.code, tmbInterpretationCoding.code)
        && Objects.equals(this.display, tmbInterpretationCoding.display)
        && Objects.equals(this.system, tmbInterpretationCoding.system)
        && Objects.equals(this.version, tmbInterpretationCoding.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class TmbInterpretationCoding {\n");
  ...
  public static class Builder {
    ...
    private TmbInterpretationCoding instance;

    public Builder() {
      this(new TmbInterpretationCoding());
    }

    protected Builder(TmbInterpretationCoding instance) {
      this.instance = instance;
    }

    public TmbInterpretationCoding.Builder code(CodeEnum code) {
    ...
    public TmbInterpretationCoding build() {
      try {
  ...
  public static TmbInterpretationCoding.Builder builder() {
    return new TmbInterpretationCoding.Builder();
  }

  public TmbInterpretationCoding.Builder toBuilder() {
    return new TmbInterpretationCoding.Builder()
        .code(getCode())
        .display(getDisplay())
        .system(getSystem())
